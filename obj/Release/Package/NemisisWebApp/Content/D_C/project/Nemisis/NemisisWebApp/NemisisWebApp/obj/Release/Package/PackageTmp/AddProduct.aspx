      ...
      <legend>Create new Product</legend>
         ...
         <p>
          ...
          <p> 
           ...
           <asp:Label ID="Label4" runat="server" Text="Cost Price" 
           ...
           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
               ...
               <p>
           <asp:Label ID="Label5" runat="server" Text="Selling Price" 
           ...
           <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
               ControlToValidate="pSellingPrice" ErrorMessage="Selling Price cannot be empty" 
               ForeColor="Red"></asp:RequiredFieldValidator>
           </p>
             <p>
           <asp:Label ID="Label6" runat="server" Text="CGST(%)" AssociatedControlID="cgst"></asp:Label>
           <asp:TextBox ID="cgst" runat="server" CssClass="textEntry" TextMode="Number"></asp:TextBox>
         
           </p>
           <p>
           <asp:Label ID="Label7" runat="server" Text="SGST(%)" AssociatedControlID="sgdt"></asp:Label>
          <asp:TextBox ID="sgdt" runat="server" 
               TextMode="Number" CssClass="textEntry" Width="121px"></asp:TextBox>
              </p>
                    </fieldset>
