...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        CellPadding="8" ForeColor="#333333" GridLines="None" ShowFooter="True" OnRowDataBound="OnRowDataBound"
                >
      ...
      <asp:TextBox ID="DiscountAmount" runat="server" TextMode="Number" Text='<%# Eval("DiscountAmount") %>' AutoPostBack="true" style="width:72px;" OnTextChanged="Refresh">
          ...
          <asp:TemplateField HeaderText="AmountAfterDiscount">
          <FooterTemplate>
     ...
     <asp:UpdatePanel ID="UP6" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
       ...
       <asp:TemplateField HeaderText="FinalPrice">
       ...
       <ContentTemplate>
               <asp:Label ID="NetFinalPrice" runat="server" Text="Label"></asp:Label>
               </ContentTemplate>
          </asp:UpdatePanel>
           </FooterTemplate>
      <ItemTemplate>
